...
class OptionParser:
    def __init__(self):
        ...
        self.parser.add_argument("--babel_pkl_path", default='', type=str,help="")
        self.parser.add_argument("--sin_path", default='', type=str,help="")
        self.parser.add_argument("--dataset", default='', type=str,help="")
